...
test( 'renders top-level folder names', () => {
	render( <FolderTree tree={ tree } onSelect={ noop } onMove={ noop } onRename={ noop } /> );
...
test( 'calls onSelect with folder path when folder name is clicked', () => {
	...
	render( <FolderTree tree={ tree } onSelect={ onSelect } onMove={ noop } onRename={ noop } /> );
...
test( 'calls onMove with attachment id and folder path on drop', () => {
	...
	render( <FolderTree tree={ tree } onSelect={ noop } onMove={ onMove } onRename={ noop } /> );
